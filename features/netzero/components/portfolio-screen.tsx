...
import type { AdjustControls, RiskAnswers, ScreenProps } from "@/features/netzero/engine/dashboard/types";
...
export function PortfolioScreen({ data, model, nav, onAnswers, onAdjust }: PortfolioScreenProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <ExplanationPanel target={{ scope: "portfolio" }} data={data} model={model} />
    </div>
  );
}
