import { reasonSentence, type PositionLabel } from "@/features/netzero/engine/reasons";
import { formatPercent, formatRatio, formatUsd, formatYears } from "@/features/netzero/engine/format";
import type { CompanyScore } from "@/features/netzero/engine/scenario";
import { PICK_ACTIVE_THRESHOLD } from "@/features/netzero/engine/sensitivity";
import { median } from "@/features/netzero/engine/stats";
import { CATEGORIES, CATEGORY_LABEL, type Category, type ScenarioData } from "@/features/netzero/engine/types";
