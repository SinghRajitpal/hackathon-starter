...
import { Panel } from "@/components/dashboard/frame";
import type { MacPoint } from "@/lib/netzero/config";
import { parseCapitalInput } from "@/lib/netzero/portfolio";
import type { AdjustControls, RiskAnswers, TrailTolerance } from "@/lib/netzero/dashboard/types";
